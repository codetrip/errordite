...
namespace CodeTrip.Core
{
    ...
    public static class ArgumentValidation
    {
        ...
        /// <exception cref="CodeTripDependentComponentException{T}" />
        public static void ComponentNotNull<T>(T component, string instanceName) where T : class
        {
            if (component == null)
                throw new CodeTripDependentComponentException<T>(instanceName);
        }
        ...
        {
            if (component == null)
                throw new CodeTripDependentComponentException<T>();
        }
