...
namespace Errordite.Notifications.Service.Controllers
{
    public class QueueController : AbstractQueueController
    {
        ...
        {
            return _serviceConfigurations.First(c => c.ServiceName.ToLowerInvariant() == "errorditenotificationsservice");
        }
    }
}
